...
```bash
youth-gps-backend$ sam logs -n HelloEfsFunction --stack-name "youth-gps-backend" --tail
```
...
```bash
youth-gps-backend$ pip install -r tests/requirements.txt --user
# unit test
youth-gps-backend$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
youth-gps-backend$ AWS_SAM_STACK_NAME="youth-gps-backend" python -m pytest tests/integration -v
```
...
```bash
sam delete --stack-name "youth-gps-backend"
```
